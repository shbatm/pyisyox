...
from pyiox.constants import EventStreamStatus
from pyiox.events.router import EventRouter
from pyiox.helpers.session import get_new_client_session, get_sslcontext
from pyiox.logging import enable_logging
...
class WebSocketClient:
    ...
    async def reconnect(self, delay: float | None = None, retries: int = 0) -> None:
        ...
        _LOGGER.info("PyIoX attempting stream reconnect in %ss.", delay)
